        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <button className="inline-flex items-center justify-center px-10 py-4 rounded-full bg-[#0b4d27] text-white text-lg font-medium hover:bg-green-800 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 opacity-50 cursor-not-allowed" title="Coming Soon">
